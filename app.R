###############################################################################
# Synoptic Fire Weather Viewer - Shiny Web Application
#
# Description:
# This Shiny app provides an interactive map-based interface for visualizing 
# synoptic-scale weather patterns, evaporative demand anomalies, and 
# active wildfire locations across the contiguous United States (CONUS).
# 
# Key Features:
# - Geopotential height contours at 500 mb, 700 mb, and 850 mb pressure levels
#   using daily NCEP/DOE Reanalysis II data.
# - Evaporative Demand Drought Index (EDDI) rasters at selectable timescales
#   (1-week to 6-month) sourced from NOAA PSL (Physical Sciences Laboratory).
# - Near real-time wildfire detection locations and metadata from the
#   Wildland Fire Interagency Geospatial Services (WFIGS) dataset.
# - Dynamic date navigation, pressure level and EDDI scale selection,
#   and custom color ramps with legend and explanatory panel.
#
# Data Sources:
# - NCEP/DOE Reanalysis II geopotential height fields:
#   https://psl.noaa.gov/data/gridded/data.ncep.reanalysis2.html
# - EDDI archive and documentation:
#   https://psl.noaa.gov/eddi
# - WFIGS Fire Incident Locations:
#   https://data-nifc.opendata.arcgis.com
#
# Notes:
# - The application is limited to current calendar year data.
# - EDDI rasters are downloaded on-demand and cached temporarily per session.
# - Data are for visualization and situational awareness only.
#
# Author: Mike Crimmins
# Affiliation: University of Arizona - Climate Science Applications Program (CSAP)
